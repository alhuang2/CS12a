...
//1471706
//lab5
//program writes letters
//
//Program error 1:The ">=" operator included the value 5 in it's range
//when it shouldn't.

//Program error 2: Extra semi-colon in the "if(m == 2);" was evaluated
//and then did nothing and ran to the next line.
//
//Program error 3: Extra semi-colon in the "else; if(...)" made the code
//jump to the "phrase = error"
//
//---------------------------------------------------------------------------------------
